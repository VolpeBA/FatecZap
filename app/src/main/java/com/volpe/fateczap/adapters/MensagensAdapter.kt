package com.volpe.fateczap.adapters
...
import com.volpe.fateczap.databinding.ItemMensagensDestinatarioBinding
import com.volpe.fateczap.databinding.ItemMensagensRemetenteBinding
...
class MensagensAdapter : Adapter<ViewHolder>() {
    ...
    class MensagensRemetenteViewHolder(
        ...
        companion object{
            fun inflatLayout( parent: ViewGroup ) : MensagensRemetenteViewHolder{
    ...
    class MensagensDestinatarioViewHolder(
        ...
        companion object{
            fun inflatLayout( parent: ViewGroup ) : MensagensDestinatarioViewHolder{
                val inflater = LayoutInflater.from( parent.context )
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        ...
        if ( viewType == Constantes.TIPO_REMETENTE){
            return  MensagensRemetenteViewHolder.inflatLayout( parent )
        }

        return MensagensDestinatarioViewHolder.inflatLayout( parent )
    }
